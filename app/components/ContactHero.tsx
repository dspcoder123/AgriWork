        ...
        >
            ...
            >
                ...
                <p style={{
                    ...
                    Connect with our team of agricultural experts to discover the <br />
                    perfect hybrid varieties for your unique agroclimatic needs.
                </p>
                ...
                >
                    <div style={{ width: '1px', height: '80px', background: 'linear-gradient(to bottom, var(--accent), transparent)', margin: '0 auto' }} />
                </motion.div>
            </motion.div>
        </section>
    );
